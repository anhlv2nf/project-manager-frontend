...
import { Initialload } from '../../../context/Initialload'
                                        ...
                                        <div className="d-flex switcher-style pb-2">
                                            ...
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Gradient Menu' >
                                                    <Form.Check.Input className="form-check-input color-input color-gradient" type="radio" name="menu-colors" id="switcher-menu-gradient" checked={variable.dataMenuStyles === 'gradient'} onChange={() => { }} onClick={() => setMenuStyle('gradient')} />
                                                </SpkTooltips>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Transparent Menu' >
                                                    <Form.Check.Input className="form-check-input color-input color-transparent" type="radio" name="menu-colors" id="switcher-menu-transparent" checked={variable.dataMenuStyles === 'transparent'} onChange={() => { }} onClick={() => setMenuStyle('transparent')} />
                                                </SpkTooltips>
                                            </Form.Check>
                                        </div>
                                    </div>
                                        ...
                                        <div className="d-flex switcher-style pb-2">
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Light Header'>
                                                    <Form.Check.Input className="form-check-input color-input color-white" type="radio" name="header-colors" id="switcher-header-light" checked={variable.dataHeaderStyles === 'light'} onChange={() => { }} onClick={() => setHeaderStyle('light')} />
                                                </SpkTooltips>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Dark Header'>
                                                    <Form.Check.Input className="form-check-input color-input color-dark" type="radio" name="header-colors" id="switcher-header-dark" checked={variable.dataHeaderStyles === 'dark'}
                                                        onChange={() => { }} onClick={() => setHeaderStyle('dark')} />
                                                </SpkTooltips>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Color Header' >
                                                    <Form.Check.Input className="form-check-input color-input color-primary" type="radio" name="header-colors" id="switcher-header-primary" checked={variable.dataHeaderStyles === 'color'} onChange={() => { }} onClick={() => setHeaderStyle('color')} />
                                                </SpkTooltips>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Gradient Header'>
                                                    <Form.Check.Input className="form-check-input color-input color-gradient" type="radio" name="header-colors" id="switcher-header-gradient" checked={variable.dataHeaderStyles === 'gradient'} onChange={() => { }} onClick={() => setHeaderStyle('gradient')} />
                                                </SpkTooltips>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Transparent Header' >
                                                    <Form.Check.Input className="form-check-input color-input color-transparent" type="radio" name="header-colors" id="switcher-header-transparent" checked={variable.dataHeaderStyles === 'transparent'} onChange={() => { }} onClick={() => setHeaderStyle('transparent')} />
                                                </SpkTooltips>
                                            </Form.Check>
                                        </div>
                                    </div>
                                        ...
                                        <div className="d-flex flex-wrap align-items-center switcher-style">
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-primary-1" type="radio" name="theme-primary" id="switcher-primary"
                                                    checked={variable.colorPrimaryRgb === ' 42 ,16, 164'} onChange={() => { }} onClick={() => setPrimaryColor(' 42 ,16, 164')} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-primary-2" type="radio" name="theme-primary" id="switcher-primary1"
                                                    checked={variable.colorPrimaryRgb === '125 ,0, 189'} onChange={() => { }} onClick={() => setPrimaryColor('125 ,0, 189')} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-primary-3" type="radio" name="theme-primary" id="switcher-primary2"
                                                    checked={variable.colorPrimaryRgb === '4, 118, 141'} onChange={() => { }} onClick={() => setPrimaryColor('4, 118, 141')} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-primary-4" type="radio" name="theme-primary" id="switcher-primary3"
                                                    checked={variable.colorPrimaryRgb === '138, 0, 32'} onChange={() => { }} onClick={() => setPrimaryColor('138, 0, 32')} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-primary-5" type="radio" name="theme-primary" id="switcher-primary4"
                                                    checked={variable.colorPrimaryRgb === '9 ,124, 103'} onChange={() => { }} onClick={() => setPrimaryColor('9 ,124, 103')} />
                                            </Form.Check>
                                        ...
                                        <div className="d-flex flex-wrap align-items-center switcher-style">
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-bg-1" type="radio" name="theme-background" id="switcher-background"
                                                    checked={variable.bodyBg === '0,8,52'} onChange={() => { }} onClick={() => updateBackgroundColor('0,8,52', ' 14,22,66', 'clicked')} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-bg-2" type="radio" name="theme-background" id="switcher-background1"
                                                    checked={variable.bodyBg === '58, 0, 109'} onChange={() => { }} onClick={() => updateBackgroundColor('58, 0, 109', '72 ,14, 123', 'clicked')} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-bg-3" type="radio" name="theme-background" id="switcher-background2"
                                                    checked={variable.bodyBg === '0 ,59, 70'} onChange={() => { }} onClick={() => updateBackgroundColor('0 ,59, 70', '14, 73, 84', 'clicked')} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-bg-4" type="radio" name="theme-background" id="switcher-background3"
                                                    checked={variable.bodyBg === ' 65, 0, 0'} onChange={() => { }} onClick={() => updateBackgroundColor(' 65, 0, 0', '79 ,14, 14', 'clicked')} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-bg-5" type="radio" name="theme-background" id="switcher-background4"
                                                    checked={variable.bodyBg === '1 ,77, 46'} onChange={() => { }} onClick={() => updateBackgroundColor('1 ,77, 46', '15 ,91, 60', 'clicked')} />
                                            </Form.Check>
                                    ...
                                    <div className="menu-image mb-3">
                                        ...
                                        <div className="d-flex flex-wrap align-items-center switcher-style">
                                            <Form.Check className="form-check switch-select m-2">
                                                <Form.Check.Input className="form-check-input bgimage-input bg-img1" type="radio" name="menu-background" id="switcher-bg-img" checked={variable.bgImg === 'bgimg1'} onChange={() => { }} onClick={() => setBgImage(1)} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select m-2">
                                                <Form.Check.Input className="form-check-input bgimage-input bg-img2" type="radio" name="menu-background" id="switcher-bg-img1" checked={variable.bgImg === 'bgimg2'} onChange={() => { }} onClick={() => setBgImage(2)} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select m-2">
                                                <Form.Check.Input className="form-check-input bgimage-input bg-img3" type="radio" name="menu-background" id="switcher-bg-img2" checked={variable.bgImg === 'bgimg3'} onChange={() => { }} onClick={() => setBgImage(3)} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select m-2">
                                                <Form.Check.Input className="form-check-input bgimage-input bg-img4" type="radio" name="menu-background" id="switcher-bg-img3" checked={variable.bgImg === 'bgimg4'} onChange={() => { }} onClick={() => setBgImage(4)} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select m-2">
                                                <Form.Check.Input className="form-check-input bgimage-input bg-img5" type="radio" name="menu-background" id="switcher-bg-img4" checked={variable.bgImg === 'bgimg5'} onChange={() => { }} onClick={() => setBgImage(5)} />
                                            </Form.Check>
                                        </div>
                                    </div>
                                </div>
